...
class FundAdvantage(AdvantageDice):
    ...
    text_dict = {
        ...
        "2" : "아무 문제없습니다. 이 또한 우리 계획의 일부입니다.",
        "3" : "대단히 관대한 조건입니다. 분명히 이익이 될 것입니다."
    }
...
class SupplyAdvantage(AdvantageDice):
    ...
    text_dict = {
        "-3" : "최악의 상황입니다. 지금 가지고 있는 것으로는 아무것도 할 수 없습니다.",
        "-2" : "모든 것이 부족합니다. 적만 빼면 말이죠.",
        "-1" : "늘 그렇듯 뭔가 항상 부족합니다.",
        "1" : "다행히 크게 부족한 것 없습니다.",
        "2" : "우리는 풍족합니다.",
...
class PublicopinionAdvantage(AdvantageDice):
    ...
    text_dict = {
        "-3" : "아무도 우리를 지지하지 않습니다. 어서 떠나야 합니다.",
        "-2" : "분위기가 적대적입니다.",
        "-1" : "뭔가 사소한 실수가 벌어진 듯합니다.",
